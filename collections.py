...
my_books = {
    "Jane Costello": ["The End Game", "Silence In The Dark", "Gone Tomorrow"],
    "Kumar Theawood": ["Streets Apart", "The Crossover", "City Of The Forgotten"],
    "Merlin James": ["Of Metal And Steel", "Afraid", "The Long Goodbye"]
}

name = input("Enter author's name: ")
print(my_books.get(name, ))

books = my_books.get(name)
if books:
    print(f"Books by {name}: {', '.join(books)}")
else:
    print(f"Books not Found for author: {name}")